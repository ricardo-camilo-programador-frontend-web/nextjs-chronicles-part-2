      ...
      <div className="space-y-6 p-2">
        <div className="bg-gradient-to-r from-green-600 to-blue-500 p-4 rounded-lg shadow-md">
          <p className="text-white text-lg font-medium text-center">
            Bem-vindo ao Portfólio - v1.0! 🚀
          </p>
        </div>

        <div className="bg-gray-50 p-4 rounded-lg">
          <p className="text-gray-700 text-center leading-relaxed">
            Esta é uma demonstração das minhas habilidades de desenvolvimento frontend, focando em tecnologias web modernas e melhores práticas.
          </p>
        </div>
        ...
        <div className="border-t pt-4 mt-4">
          ...
          <p className="text-sm text-gray-500 text-center mt-1">
            <a
              href={`https://www.figma.com/community/file/${figmaOriginalDesign}`}
              target="_blank"
              rel="noopener noreferrer"
