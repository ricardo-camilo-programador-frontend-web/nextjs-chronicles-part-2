...
const variantsMapping: KeyValuePairProps = {
  h1: "text-3xl tracking-[-0.3px] font-medium sm:text-5xl font-medium text-gray-900 dark:text-gray-100",
  h2: "text-2xl tracking-[0.36px] font-semibold text-gray-900 dark:text-gray-100",
  h3: "text-xl font-semibold text-gray-900 dark:text-gray-100",
  body1: "text-base text-gray-900 dark:text-gray-300",
  body2: "text-xs text-gray-900 dark:text-gray-400",
};
