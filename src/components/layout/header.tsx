...
const Header = () => {
  ...
  return (
    <header className="flex p-8 justify-center max-lg:px-4 sticky top-0 backdrop-blur-md bg-white/70 dark:bg-zinc-950/70 supports-[backdrop-filter]:bg-white/40 dark:supports-[backdrop-filter]:bg-zinc-950/40 z-50">
      <div className="flex max-w-7xl w-full justify-between">
        <Link
          href="/"
          className="text-xl font-medium uppercase text-zinc-900 dark:text-zinc-100 tracking-[1px] min-w-[17rem] cursor-pointer"
          rel="home"
